...
const displayCard = (characterData) => {
    ...
    newLi.innerHTML = `
            <div class="card character__card">
                ...
                />
                <div class="card-body">
                    <h2 class="character__name card-title h4">${characterData.name} ${characterData.familyName}</h2>
                    <div class="character__info">
                        <ul class="list-unstyled">
                            <li>Edad: ${characterData.age} años</li>
                            <li>
                                Estado:
                                <i class="fas fa-thumbs-down" id="down${characterData.name}"></i>
                                <i class="fas fa-thumbs-up" id="up${characterData.name}"></i>
                            </li>
                        </ul>
                    </div>
                    <div class="character__overlay">
                        ...
                        <div class="character__actions">
                            <button class="character__action btn" id="talk${characterData.name}">habla</button>
                            <button class="character__action btn"  id="die${characterData.name}">muere</button>
                        </div>
                    </div>
                </div>
